...
public final class WitherStormSegmentPulseLayer
    ...
    public WitherStormSegmentPulseLayer(WitherStormSegmentRenderer renderer) {
    ...
    public void doRenderLayer(SupplementalEntities.WitherStormSegmentEntity entity,
        ...
        ((WitherStormSegmentModel) renderer.getMainModel())
                .renderPulse(entity, partialTicks, scale);
